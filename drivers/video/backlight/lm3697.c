...
void lm3697_backlight_on(int level)
{
	...
	if (backlight_status == BL_OFF) {
		...
		lm3697_write_reg(main_lm3697_dev->client, 0x17, 0x13);	//Bank A Full-scale current
		lm3697_write_reg(main_lm3697_dev->client, 0x18, 0x13);	//Bank B Full-scale current
