...
static struct msm_camera_i2c_reg_conf hi351_720p_settings_in_case_of_init[2][250] = {
//60hz
	{
		{0x03, 0xFE, MSM_CAMERA_I2C_BYTE_DATA},
		{0xFE, 0x1E, MSM_CAMERA_I2C_BYTE_DATA}, //Delay 30ms
...
//60hz
	{
		...
		{0x03, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
		{0xf0, 0x00, MSM_CAMERA_I2C_BYTE_DATA}, //LPF status: only Dark2 mode
...
static struct msm_camera_i2c_reg_conf hi351_recover_from720P_settings_in_case_of_init[2][250] = {
//60hz
	{
		{0x03, 0xFE, MSM_CAMERA_I2C_BYTE_DATA},
		{0xFE, 0x1E, MSM_CAMERA_I2C_BYTE_DATA}, //Delay 30ms
