...
int32_t proxy_i2c_write(uint16_t addr, uint16_t data, enum msm_camera_i2c_data_type data_type);
int32_t proxy_i2c_read(uint16_t addr, uint16_t *data, enum msm_camera_i2c_data_type data_type);
int32_t proxy_i2c_write_seq(uint16_t addr, uint8_t *data, uint16_t num_byte);
int32_t proxy_i2c_read_seq(uint16_t addr, uint8_t *data, uint16_t num_byte);
